function [Pose_t,Pose_est,Pk] = poseIntegration2(V,Pk0,IC,L,R,S,error) % IC->Initial Condition [xo,yo,th0]
...
x_w = x_w - error(1);
y_w = y_w - error(2);
%suma_theta = mod((suma_theta - error(3)) ,2*pi);   
% no supimos como aplicar el error en theta, restandolo sal¨ªa una
% trayectoria bastante rara
